...
namespace iSmash.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,SenderId,RecipientId,IsRead,Sent,Body")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,SenderId,RecipientId,IsRead,Sent,Body")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
